...
- **Forum System**: Partitioned forums with support for threads and replies
- **User Following System**: Follow specific users, receive online notifications
- **Permission Management System**: Fine-grained user permission control
- **Admin Panel**: Complete user, chat, and forum management
- **File Management**: Admins can manage server files
- **Online Status Monitoring**: Real-time display of online user count and user lists
